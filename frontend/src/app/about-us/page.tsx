...
const AboutUs: React.FC = () => {
    return (
        <div className="bg-gray-100 mt-10">
            ...
            {/*Who We Are...*/}
            <div className="py-20 bg-[#E0AF2A] shadow-inner min-h-screen">
                <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
                    <div className="md:w-1/2 p-8">
                        <h2 className="text-6xl font-bold text-gray-800 mb-4">Who We Are</h2>
            ...
            {/* Leadership Section */}
            <div
                className="py-20 bg-gradient-to-r from-gray-200 to-gray-300 shadow-inner h-screen flex flex-col md:flex-row items-center">
                {/* Image block */}
