...
// import { FaScrewdriver, FaHardHat, FaCheckCircle } from 'react-icons/fa';
//
...
//                         <img src="/GuardRailTruck10.webp" alt="Guardrail: Installation & Repair" className="w-full h-auto rounded-lg" />
//                     </div>
//                 </div>
//             </div>
//         </div>
