...
import { FaScrewdriver, FaGears } from 'react-icons/fa';

export default function OverheadSignStructures() {
    return (
                ...
                <div className="w-full bg-white p-6 rounded-lg flex lg:flex-wrap justify-center items-center">
                    ...
                    <div className="w-full lg:w-1/2 md:p-12">
                        ...
                        <div className="lg:hidden flex w-full lg:w-1/2 my-20 md:my-24">
                            <img src="/SignStructure3-1.webp" alt="Erecting Overhead Sign Structures" className="w-auto h-64 rounded-lg" />
                        </div>
                    ...
                    <div className="hidden lg:flex w-full lg:w-1/2 p-6 md:p-12">
                        <img src="/SignStructure3-1.webp" alt="Erecting Overhead Sign Structures" className="w-auto h-auto rounded-lg " />
                    </div>
                </div>
            </div>
        </div>
